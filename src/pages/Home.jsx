                    ...
                    <div className="col-lg-8 col-md-10 text-center">
                      <div className="hero-content">
                        ...
                        <div className="hero-btns">
                          <Link to="/reservation" className="btn btn-rose-gold">Demander un devis</Link>
                          <Link to="/galerie" className="btn btn-outline-light">Voir la galerie</Link>
                        </div>
                      </div>
                    </div>
                  </div>
        ...
        <div className="container">
          <div className="row align-items-center">
            ...
            <div className="col-lg-6 ps-lg-5" data-aos="fade-left" data-aos-delay="100">
              ...
              <Link to="/contact" className="btn btn-rose-gold">Nous contacter</Link>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="section-services bg-light-bg">
        <div className="container">
                ...
                <div className="service-card h-100">
                  <div className="service-image">
                    ...
                    <div className="service-overlay">
                      <Link to="/services" className="service-overlay-link">Découvrir</Link>
                    </div>
                  </div>
          ...
          <div className="text-center mt-4">
            <Link to="/services" className="btn btn-outline-rose-gold">Voir toutes nos prestations</Link>
          </div>
        </div>
      </section>
      ...
      <section className="section-gallery">
        <div className="container">
          ...
          <div className="text-center mt-5">
            <Link to="/galerie" className="btn btn-rose-gold">Voir toute la galerie</Link>
          </div>
        </div>
      </section>
      ...
      <section className="section-cta">
        <div className="container">
          ...
          <div className="d-flex justify-content-center gap-3 flex-wrap mt-4">
            <Link to="/reservation" className="btn btn-white-gold">Faire une demande</Link>
            <Link to="/contact" className="btn btn-outline-light">Nous contacter</Link>
          </div>
        </div>
      </section>
